...
test.only("Handle promt alert page.on",async({page})=>{
    ...
    // https://forms.office.com/r/seAtnmW796
    switch (alertName) {
        case'confirm': type.accept()
        case'prompt':type.accept("My response")
        default:return("Do sure what to do here");
